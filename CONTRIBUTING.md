...
- Use [GitHub Issues](https://github.com/JoeKuster-Q/M365-Assess/issues) to report bugs or request features
...
4. The `release.yml` workflow validates and creates a GitHub Release

Pre-release tags (e.g., `v1.0.0-beta1`) create a pre-release GitHub Release. Use `workflow_dispatch` to test packaging without creating a release.
